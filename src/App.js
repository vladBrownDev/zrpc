          ...
          <section id="reviews">
            ...
            <div id="reviewGrid">
              <Review1 
                ...
                review1Small={this.state.currentLang.patientReviews.partient1.review1Small}
                review2Small={this.state.currentLang.patientReviews.partient1.review2Small}
                /> 
              <Review1
                image={review2} 
                ...
                review1Small={this.state.currentLang.patientReviews.partient2.review1Small}
                review2Small={this.state.currentLang.patientReviews.partient2.review2Small}
                />  
              <Review1 
                image={review3}
                ...
                review1Small={this.state.currentLang.patientReviews.partient3.review1Small}
                review2Small={this.state.currentLang.patientReviews.partient3.review2Small}
                />
            </div>
