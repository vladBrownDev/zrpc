    ...
    ukr: {
        ...
        patientReviews: {
            ...
            partient3: {
                ...
                review2: "Звичайно, період реабілітації був досить важким, але в цілому, на інше я не розраховував. Всім величезне спасибі, за те що робите нас здоровіше! "
            }
        }
    },
    rus : {
        ...
        patientReviews: {
            ...
            partient3: {
                ...
                review2: "Конечно, период реабилитации был достаточно тяжелым, но в целом ,на другое я не расчитывала. Всем огромное спасибо, за то что делаете нас здоровее!"
            }
        }
    }
}
