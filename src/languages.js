    ...
    ukr: {
        ...
        patientReviews: {
            partient1: {
                ...
                "назначення лікарів. Хірурги, в свою чергу, якісно виконують свою роботу. У цілому, я залишилась" +
            ...
            partient2: {
                ...
                review2: "Переживання були, однозначно, але після спілкування з лікарем всі сумніви розвіялися. Прооперували. Проведеною операцією залишився задоволений. Стан покращився. Переживав даремно."
            },
            partient3: {
                name: "Наталя Пілюк",
                position: "Пацієнт",
                ...
                review2: "Звичайно, період реабілітації був досить важким, але в цілому, на інше я не розраховував. Медсестри дуже добрі. Завжди зайвий раз підійдуть. У відділенні завжди все чисто. Всім величезне спасибі, за те що робите нас здоровіше! "
            }
        }
    },
    rus : {
        ...
        patientReviews: {
            partient1: {
                ...
                "назначения врачей. Хирурги, в свою очередь, качественно выполняют свою работу. В целом, я осталась " +
                "довольна лечением."
            },
            partient2: {
                ...
                review2: "Переживания были, однозначно, но после общения с врачём все сомнения развеялись. Прооперировали. Проведенной операцией остался доволен. Состояние улучшилось. Переживал зря."
            },
            partient3: {
                name: "Наталья Пилюк",
                position: "Пациент",
                ...
                review2: "Конечно, период реабилитации был достаточно тяжелым, но в целом ,на другое я не расчитывала. Медсестры очень добрые. Всегда лишний раз подойдут. В отделении всегда все чисто. Всем огромное спасибо, за то что делаете нас здоровее!"
            }
        }
    }
}
